...
#calling scripts
        ...
        def r_b():
            os.system('python remove_book.py')

        def r_s():
            os.system('python Remove_student.py')

        def ib():
            os.system('python issueTable.py')

        def rb1():
            os.system('python renew.py')

        def ret():
            os.system('python ret.py')
      ...
      # def handle(event):
        ...
        def rem_user():
            os.system('python Rem.py')
        def cfine():
            os.system('python fine.py')
        def sest():
        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='Kanchantala JDJ Library Manager',fg='black',bg="white" ,font=('AlGERIAN', 30, 'bold'))
